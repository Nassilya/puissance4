...
# ----------- Paramètres du tournoi pour IA facile -----------
comparaisons_ia = [
    ("facile", "facile"),
    ("facile", "moyen"),
    ("facile", "difficile")
...
plt.barh(noms, valeurs, color='#FA82C6')
plt.xlabel("Temps moyen par match (secondes)")
plt.title("Temps d'exécution moyen par confrontation IA")
plt.tight_layout()
plt.show()
